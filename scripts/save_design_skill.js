...
const globalDir = "C:\\\\Users\\\\armyn\\\\.gemini\\\\config\\\\skills\\\\premium-ui-ux-design-standards";
fs.mkdirSync(globalDir, { recursive: true });
fs.writeFileSync(path.join(globalDir, "SKILL.md"), skillContent, "utf8");

const globalRuleDir = "C:\\\\Users\\\\armyn\\\\.gemini\\\\config\\\\rules";
fs.mkdirSync(globalRuleDir, { recursive: true });
fs.writeFileSync(path.join(globalRuleDir, "ui-design-standards.md"), skillContent, "utf8");

// Also save in local workspace .agents/
const localDir = path.join(__dirname, "..", ".agents", "skills", "premium-ui-ux-design-standards");
fs.mkdirSync(localDir, { recursive: true });
fs.writeFileSync(path.join(localDir, "SKILL.md"), skillContent, "utf8");

const localRuleDir = path.join(__dirname, "..", ".agents", "rules");
fs.mkdirSync(localRuleDir, { recursive: true });
fs.writeFileSync(path.join(localRuleDir, "ui-design-standards.md"), skillContent, "utf8");

console.log("SUCCESSFULLY_SAVED_SKILL_AND_RULES_GLOBALLY_AND_LOCALLY");
